...
/datum/symptom/fire/proc/Firestacks_stage_4(mob/living/M, datum/disease/advance/A)
	var/get_stacks = max((sqrtor0(20 + A.totalStageSpeed() * 2)) - (sqrtor0(16 + A.totalStealth())), 1) * A.getImmunityLossMultiplier(2)
	M.adjust_fire_stacks(get_stacks)
	M.adjustFireLoss(get_stacks * 0.5)
	return 1

/datum/symptom/fire/proc/Firestacks_stage_5(mob/living/M, datum/disease/advance/A)
	var/get_stacks = max((sqrtor0(20 + A.totalStageSpeed() * 3))-(sqrtor0(16 + A.totalStealth())), 1) * A.getImmunityLossMultiplier(2)
	M.adjust_fire_stacks(get_stacks)
